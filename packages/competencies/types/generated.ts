...
export type GetManyCompetenciesQueryVariables = Exact<{
  data?: InputMaybe<CompetencyInput>;
  params?: InputMaybe<PageParamsInput>;
  includeDefinition: Scalars['Boolean']['input'];
}>;
