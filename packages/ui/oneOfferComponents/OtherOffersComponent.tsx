...
export default function OtherOffersComponent({ offre }: { offre: Offer }) {
  ...
  return (
    <div className="dark:mediumDarkBg bg-grey50 flex w-full flex-col items-center p-[12px] xs:p-[6px] sm:p-[6px] md:p-[6px] box-border gap-[24px] xs:gap-[12px] sm:gap-[12px] border-[0.5px] border-solid border-grey300">
      <div className="flex w-full flex-col items-center p-[24px] xs:p-[12px] sm:p-[12px] md:p-[12px] box-border gap-[24px] bg-white dark:mediumDarkBg h-full border-[0.5px] border-solid border-grey300 rounded-xl">
