...
export default function HomeSquares() {
  return (
    <div className="flex flex-col w-full">
      <div
        data-aos="fade-left"
        className="flex flex-col items-start w-full p-[48px] xs:p-[12px] sm:p-[24px] md:p-[24px] box-border"
      >
      ...
      <div
        data-aos="fade-right"
        className="flex flex-col items-end w-full p-[48px] xs:p-[12px] sm:p-[24px] md:p-[24px] box-border"
      >
