...
import BackofficeLeadsComponent from "@youmeet/app/backoffice/backofficeComponents/BackofficeLeadsComponent";
import dynamic from "next/dynamic";

const MoreFeaturesLeads = dynamic(
  () => import("@youmeet/app/backoffice/backofficeComponents/MoreFeaturesLeads")
);
